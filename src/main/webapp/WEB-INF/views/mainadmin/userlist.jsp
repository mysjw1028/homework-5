		...
		<table class="table table-users" id="datatable" border="2">
			<thead>
				<tr>
					...
					<th>구매자 탈퇴</th>
					<th>구매자 구매내역 삭제</th>
					<th class="hidden" name="usersId">관리자 아이디</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="users" items="${users}">
					<tr>
						...
						<form action="/Mainadmin/userlist/${usersId}/edit" method="GET">
							<input type="hidden" value="${users.usersId}" name="adminId">
							<td><button type="submit" class="btn btn-primary">구매자 정보 수정</button></td>
						</form>

						<form action="/Mainadmin/userlist/${usersId}/delete" method="POST">
